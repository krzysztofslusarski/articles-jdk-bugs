...
import org.apache.http.impl.conn.HackedPoolingHttpClientConnectionManager;
...
class ClientConfiguration {
    @Bean
    @SneakyThrows
    HttpClient httpClient(HackedPoolingHttpClientConnectionManager httpClientConnectionManager) {
    ...
    @Bean
    @SneakyThrows
    HackedPoolingHttpClientConnectionManager httpClientConnectionManager() {
        ...
        HackedPoolingHttpClientConnectionManager connectionPoolManager = new HackedPoolingHttpClientConnectionManager(registry);
